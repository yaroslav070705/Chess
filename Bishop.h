...
class Bishop: public BaseFigure{   ///< класс слона
 public:
    Bishop(int type0, int x_cell0, int y_cell0, COLORREF main_color0, COLORREF side_color0) : BaseFigure(type0, x_cell0, y_cell0, main_color0, side_color0){}   ///< конструктор
